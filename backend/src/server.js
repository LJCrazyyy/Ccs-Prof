...
app.post('/auth/create-student', async (request, response) => {
  try {
    const result = await createStudentUser(request.body);
    response.status(201).json(result);
  } catch (error) {
...
app.post('/auth/create-admin', async (request, response) => {
  try {
    const result = await createAdminUser(request.body);
    response.status(201).json(result);
  } catch (error) {
...
app.post('/auth/create-faculty', async (request, response) => {
  try {
    const result = await createFacultyUser(request.body);
    response.status(201).json(result);
  } catch (error) {
